...
{{/*
Create the default FQDN for application headless service.
*/}}
{{- define "application.svc.headless" -}}
{{- printf "%s-headless" (include "application.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
